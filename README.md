...
| 773            | [133424](https://pubmlst.org/bigsdb?page=info&db=pubmlst_neisseria_isolates&id=133424)           |
| 774            | [135049](https://pubmlst.org/bigsdb?page=info&db=pubmlst_neisseria_isolates&id=135049)           |

Click on an ID to be directed to the associated isolate submission and to export the allele sequence in FASTA format. Alternatively, Enter the ID number from the above list onto the following website to access or export allele sequences in FASTA format:
https://pubmlst.org/bigsdb?db=pubmlst_neisseria_isolates&page=query
